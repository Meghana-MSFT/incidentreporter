...
namespace Microsoft.Teams.Apps.RemoteSupport.Cards
{
    ...
    public class TicketCard : ITicketCard
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TicketCard"/> class.
        /// </summary>
        /// <param name="cardHelper">Microsoft Application credentials for Bot/ME.</param>
        public TicketCard(ICardHelper cardHelper)
        {
        ...
        public Attachment GetNewTicketCard(CardConfigurationEntity cardConfiguration, IStringLocalizer<Strings> localizer, bool showValidationMessage = false, TicketDetail ticketDetail = null)
        {
            ...
            ticketAdditionalFields = this.cardHelper.ConvertToAdaptiveCard(localizer, cardConfiguration.CardTemplate, showDateValidation);
        ...
        public Attachment GetTicketDetailsForPersonalChatCard(Dictionary<string, string> cardElementMapping, TicketDetail ticketDetail, IStringLocalizer<Strings> localizer, bool isEdited = false)
        {
            ticketDetail = ticketDetail ?? throw new ArgumentNullException(nameof(ticketDetail));
            ...
            foreach (KeyValuePair<string, string> ticketField in ticketAdditionalDetail)
            {
                ...
                ticketAdditionalFields.Add(this.cardHelper.GetAdaptiveCardColumnSet(cardElementMapping.ContainsKey(key) ? cardElementMapping[key] : key, ticketField.Value));
            }
            ...
            dynamicElements.AddRange(new List<AdaptiveElement>
            {
                ...
                this.cardHelper.GetAdaptiveCardColumnSet(localizer.GetString("RequestNumberText"), $"#{ticketDetail.RowKey}"),
                this.cardHelper.GetAdaptiveCardColumnSet(localizer.GetString("RequestTypeText"), ticketDetail.RequestType),
                this.cardHelper.GetAdaptiveCardColumnSet(localizer.GetString("TitleDisplayText"), ticketDetail.Title),
            });
            dynamicElements.AddRange(ticketAdditionalFields);
            dynamicElements.Add(this.cardHelper.GetAdaptiveCardColumnSet(localizer.GetString("DescriptionText"), ticketDetail.Description));
