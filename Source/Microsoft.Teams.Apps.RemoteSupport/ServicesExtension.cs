...
namespace Microsoft.Teams.Apps.RemoteSupport
{
    ...
    public static class ServicesExtension
    {
        ...
        public static void AddProviders(this IServiceCollection services)
        {
            ...
            services.AddSingleton<ITicketCard, TicketCard>();
            services.AddSingleton<IEditRequestCard, EditRequestCard>();
            services.AddSingleton<IAdaptiveElementHelper, AdaptiveElementHelper>();
            services.AddSingleton<ICardHelper, CardHelper>();
            services.AddSingleton<IOnCallSMEDetailCard, OnCallSMEDetailCard>();
            services.AddSingleton<ISearchHelper, SearchHelper>();
            services.AddSingleton<ITicketHelper, TicketHelper>();
            services.AddSingleton<ISmeTicketCard, SmeTicketCard>();
            services.AddSingleton<IActivityHelper, ActivityHelper>();
